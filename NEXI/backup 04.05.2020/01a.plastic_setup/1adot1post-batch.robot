...
*** Variables ***
${test case name}  01a.01       # required to fetch the correct plastic from text file
...
${company id}       3104   # Required to get the date

${environmentdate}      # set by 'get environment date'
