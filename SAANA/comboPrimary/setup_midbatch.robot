...
#step 7
    ...
    from ISPF search for combo cards in file   ${alternative_ plastic1}  ${alternative_plastic2}  PPR1O.X91XEVRO.DAILY

#Step 9
    Run Keyword if    '${environment name}' == 'CK0A'      from ISPF search for combo cards in file   ${plastic1}  ${plastic2}  PPRFL.X91EVFBI
